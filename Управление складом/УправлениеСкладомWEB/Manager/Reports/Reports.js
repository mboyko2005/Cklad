document.addEventListener("DOMContentLoaded", () => {
  ...
  // Функция для получения данных отчёта с сервера через fetch с относительным URL
  ...
  async function generateChart() {
    ...
    try {
      ...
      // { "labels": [...], "data": [...], "title": "Отчёт", "xTitle": "X", "yTitle": "Y" }
  ...
  // Обработка изменений полноэкранного режима для обновления размера диаграммы
